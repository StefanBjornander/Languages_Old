...
-import(eqc_gen,
  [pick/1,pick/2,
	...
	binary/0, binary/1, % bitstring/0, bitstring/1, -- wait for R12B
...
-import(eqc,[withseed/2,fails/1,collect/2,classify/3,aggregate/2,measure/3,
	     numtests/2,
	     quickcheck/1,quickcheck/2,quickcheck/3,
	     counterexample/0,counterexample/1,counterexample/2,counterexample/3,
	     module/1,
	     check/2,
	     recheck/0,recheck/1]).
